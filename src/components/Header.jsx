        ...
        <nav className="bg_black">
          ...
          >
            <div className="d-flex justify-content-between align-items-center w-100 ">
              ...
              <ul className="d-flex gap-2 py-3 list-unstyled d-none d-lg-flex align-items-center mb-0 justify-content-end">
                ...
                <li>
                  <a className=" ff_gilroy_normal text-white fs_16" href="#">
                    Portfolio
                  </a>
                </li>
                <li>
              ...
              <ul className="d-flex gap-3 py-3 list-unstyled d-none d-lg-flex align-items-center mb-0 justify-content-end">
                <li className=" position-relative afterline d-none d-xxl-flex">
                  <a className=" ff_gilroy_normal text-white fs_16" href="#">
                    1 888 266-6917 (eu?)
                  </a>
                </li>
                ...
                <li>
                  <a
                    className="ff_gilroy_semibold Primary_btn d-inline-block fw-semibold fs_18 text-white"
                    href="#"
                  >
                    Contact Us
                  </a>
                ...
                <li className=" before_line position-relative ms-2">
                  <a href="#">
                    <Dropdown>
                      <Dropdown.Toggle variant="success" id="dropdown-basic">
                        <svg
                        ...
                        <a
                          className="ff_gilroy_normal text-white fs_18 before_line"
                          href="#"
                        ></a>
                      </Dropdown.Toggle>

                      <Dropdown.Menu style={{ zIndex: "12" }}>
                        <Dropdown.Item href="#/action-1">Action</Dropdown.Item>
                        <Dropdown.Item href="#/action-2">
                          1 888 266-6917 (eu?)
                        </Dropdown.Item>
                        <Dropdown.Item href="#/action-3">
                          <a
                            className="ff_gilroy_semibold py-2 px-1 fw-semibold fs_16 text-white"
                            href="#"
                          >
                            Contact Us
                          </a>
            ...
            <div className="d-lg-none d-flex ">
              <div className={` ${navShow ? "shownav" : " hidenav"}`}>
                <ul className="d-flex gap-2 py-3 h-100 list-unstyled flex-column align-items-center mb-0 justify-content-center align-items-center">
                  <li className=" position-relative ">
                    <Dropdown>
                      <Dropdown.Toggle variant="success" id="dropdown-basic">
                        <a
                          className=" fs_18 ff_gilroy_normal text-white"
                          href="  WordPress Solution"
                        >
                          WordPress Solution
                        </a>
                        <svg
                  ...
                  <li>
                    <a className=" ff_gilroy_normal text-white fs_18" href="#">
                      Portfolio
                    </a>
                  </li>
                  <li>
